...
test_that("repeated_rarefaction_works", {
  ...
  vdiffr::expect_doppelganger("Test_threshold_single_threshold", result$index_plot)
  ...
  vdiffr::expect_doppelganger("Test_threshold_multiple_threshold", result_2$index_plot)
  ...
  vdiffr::expect_doppelganger("Test_threshold_multiple_threshold_unmet_index", result_3$index_plot)
  vdiffr::expect_doppelganger("Test_threshold_multiple_threshold_unmet_ordination", result_3$ordination_plots$`repeat_number 10`[[1]])
})
